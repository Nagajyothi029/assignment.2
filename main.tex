...
\begin{lemma}
\label{lemma}
The coordinates of \textbf{D} and \textbf{R} can be written as follows:
\begin{align}
  & \vec{D} = a \mathbf{e}  \quad \brak{\because \vec{E}=\myvec{0\\0}} \label{eq a}
\\
  & \vec{R} =\vec{A} + c \mathbf{a} \label{eq b}
\end{align}
 \item Let us define e,a as:
\begin{align}
 \mathbf{e} = \myvec{\cos E \\\sin E } ,\mathbf{a} = \myvec{\cos A\\\sin A }
\end{align}
\end{lemma}
\begin{itemize}
...
\begin{align}
&\implies \vec{D}=4\myvec{\cos 60\degree \\\sin 60\degree }
\\
&\implies \vec{D}=\myvec{2\\3.46}
\end{align}
\begin{itemize}
\item For finding coordinates of R:-
\end{itemize}
 Putting \eqref{eq2} and \eqref{eq5} in \eqref{eq b} we get,
\begin{align}
&\implies \vec{R}=\myvec{5\\0} + 4.5\myvec{\cos 90\degree \\\sin 90\degree }
\\
&\implies \vec{R}=\myvec{5\\0} + \myvec{0\\1}
\\
&\implies \vec{R}=\myvec{5\\1}
\end{align}
 Now,the vertices of given Quadrilateral DEAR can be written as,
\begin{align}
 \vec{D}=\myvec{2\\3.46},\vec{E} = \myvec{0\\0}, \vec{A}=\myvec{5\\0},\vec{R}=\myvec{5\\1}
\end{align}
     \item On constructing the quadrilateral $DEAR$ we get:
\numberwithin{figure}{section}
\begin{figure}[!ht]
\centering
\includegraphics[ width=\columnwidth]{download (1).png}
\caption{Quadrilateral DEAR}
\label{fig:Quadrilateral DEAR}	
\end{figure}
\end{enumerate}  
\end{document}